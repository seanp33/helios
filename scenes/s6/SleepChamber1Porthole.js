...
const TAGS = ['sleep chamber porthole 1', 'chamber 1 porthole', 'porthole']
...
class SleepChamber1Porthol {
    ...
    onAction(action) {
        ...
        switch (type) {
            case EXAMINE:
                this.game.apply(MESSAGE, `You peer into Sleep Chamber 1 and see the partial remains of some passenger - a collapsed human skeleton surrounded by a mound of ash. You wonder to yourself if H.O.P.E has additional information on each chamber and the passengers they contained.`)
                break
            default:
